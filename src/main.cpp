...
const string strMessageMagic = "XaruCoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees, int nHeight)
{
    ...
    if (pindexBest->nMoneySupply < MAX_MONEY){
        if(pindexBest->nHeight == 0) //premine 2.7M 3% MAX_MONEY*0.03
        {
...
#ifdef ENABLE_WALLET
// XaruCoin: attempt to generate suitable proof-of-stake
