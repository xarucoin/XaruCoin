...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeXaruCoinAmount"))
        settings.setValue("nAnonymizeXaruCoinAmount", 1000);

    nDarksendRounds = settings.value("nDarksendRounds").toLongLong();
    nAnonymizeXaruCoinAmount = settings.value("nAnonymizeXaruCoinAmount").toLongLong();
    ...
    if (settings.contains("nAnonymizeXaruCoinAmount"))
        SoftSetArg("-anonymizeXaruCoinamount", settings.value("nAnonymizeXaruCoinAmount").toString().toStdString());
}
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case anonymizeXaruCoinAmount:
            nAnonymizeXaruCoinAmount = value.toInt();
            settings.setValue("nAnonymizeXaruCoinAmount", nAnonymizeXaruCoinAmount);
            emit anonymizeXaruCoinAmountChanged(nAnonymizeXaruCoinAmount);
            break;
        default:
            break;
        }
